  ...
  event.waitUntil(clients.matchAll({
    ...
    .then(function(clientList) 
    {
        for (var i = 0; i < clientList.length; i++) {
          ...
          if (client.url == 'https://koophardwareonlinestore.com/admin/orders/ordered' && 'focus' in client)
            return client.focus();
        }
        if (clients.openWindow)
          return clients.openWindow('https://koophardwareonlinestore.com/admin/orders/ordered');
      }));
};